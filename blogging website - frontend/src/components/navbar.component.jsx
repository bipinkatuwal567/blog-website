  ...
  return (
    <nav className="navbar">
      ...
      >
        ...
        <i class="fi fi-rr-search absolute right-[10%] top-1/2 -translate-y-1/2 md:pointer-events-none md:left-5 text-dark-grey text-xl"></i>
      </div>
      ...
      <div className="flex items-center gap-3 md:gap-6 ml-auto">
        ...
        >
          <i class="fi fi-rr-search text-dark-grey text-xl"></i>
        </button>
